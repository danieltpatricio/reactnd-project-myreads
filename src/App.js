...
class BooksApp extends Component {
  ...
  state = {
    ...
    setSituationBooks = (book,situation) => {
    console.log("funfou")
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                {this.state.situationsBooks.map((situation) =>{
                    return(
                      <div className="bookshelf" key={situation.id}>
                      <h2 className="bookshelf-title">{situation.title}</h2>
                      <div className="bookshelf-books">
                        <ListBooks books={this.state.books} situation={situation} situations={this.state.situationsBooks}></ListBooks>
                      </div>
                    </div>
                    )
                })
